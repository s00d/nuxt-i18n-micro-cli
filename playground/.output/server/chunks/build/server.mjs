import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineComponent, h, computed, unref, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, shallowRef, isReadonly, withCtx, isRef, isShallow, isReactive, toRaw } from 'vue';
import http from 'node:http';
import https from 'node:https';
import { l as destr, m as defu, n as sanitizeStatusCode, o as createError$1, p as getRequestHeaders, q as parse, r as getRequestHeader, t as getRequestURL, v as isEqual, w as setCookie, x as getCookie, y as deleteCookie } from '../runtime.mjs';
...
const unhead_2ib1LMFO1n = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "dir1-slug",
    path: "/dir1/:slug()",
    component: () => import('./_slug_-DOlw15Pk.mjs').then((m) => m.default || m)
  },
  {
    name: "dir1",
    path: "/dir1",
    component: () => import('./index-60Zw9Fpv.mjs').then((m) => m.default || m)
  },
  {
    name: "dir1-subdir-hash-subhash",
    path: "/dir1/subdir/:hash()/:subhash()",
    component: () => import('./_subhash_-C7OiKNMm.mjs').then((m) => m.default || m)
  },
  {
    name: "dir1-subdir-slug-id-key",
    path: "/dir1/subdir/:slug()-:id()-:key()",
    component: () => import('./_slug_-_id_-_key_-CvvlxJIk.mjs').then((m) => m.default || m)
  },
  {
    name: "dir1-subdir",
    path: "/dir1/subdir",
    component: () => import('./index-BKrBkmQ4.mjs').then((m) => m.default || m)
  },
  {
    name: "dir2-slug",
    path: "/dir2/:slug()",
    component: () => import('./_slug_-DkbqzjaO.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-cml_rQMI.mjs').then((m) => m.default || m)
  },
  {
    name: "page",
    path: "/page",
    component: () => import('./page-CDT9j8XL.mjs').then((m) => m.default || m)
  },
  {
    name: "subpage",
    path: "/subpage",
    component: () => import('./subpage-SOnaCTwT.mjs').then((m) => m.default || m)
  },
  {
    name: "localized-dir1-slug",
    path: "/:locale(de|ru)/dir1/:slug()",
    component: () => import('./_slug_-DOlw15Pk.mjs').then((m) => m.default || m)
  },
  {
    name: "localized-dir1",
    path: "/:locale(de|ru)/dir1",
    component: () => import('./index-60Zw9Fpv.mjs').then((m) => m.default || m)
  },
  {
    name: "localized-dir1-subdir-hash-subhash",
    path: "/:locale(de|ru)/dir1/subdir/:hash()/:subhash()",
    component: () => import('./_subhash_-C7OiKNMm.mjs').then((m) => m.default || m)
  },
  {
    name: "localized-dir1-subdir-slug-id-key",
    path: "/:locale(de|ru)/dir1/subdir/:slug()-:id()-:key()",
    component: () => import('./_slug_-_id_-_key_-CvvlxJIk.mjs').then((m) => m.default || m)
  },
  {
    name: "localized-dir1-subdir",
    path: "/:locale(de|ru)/dir1/subdir",
    component: () => import('./index-BKrBkmQ4.mjs').then((m) => m.default || m)
  },
  {
    name: "localized-dir2-slug",
    path: "/:locale(de|ru)/dir2/:slug()",
    component: () => import('./_slug_-DkbqzjaO.mjs').then((m) => m.default || m)
  },
  {
  ...
  {
    name: "localized-page",
    path: "/:locale(de|ru)/page",
    component: () => import('./page-CDT9j8XL.mjs').then((m) => m.default || m)
  },
  {
    name: "localized-subpage",
    path: "/:locale(de)/subpage",
    component: () => import('./subpage-SOnaCTwT.mjs').then((m) => m.default || m)
  },
  {
    name: "localized-subpage-ru",
    path: "/:locale(ru)/localesubpage",
    component: () => import('./subpage-SOnaCTwT.mjs').then((m) => m.default || m)
  }
];
...
const revive_payload_server_NfQwuc17fT = /* @__PURE__ */ defineNuxtPlugin({
...
function useTranslationHelper() {
  return {
    ...
    getTranslation: (locale, routeName, key) => {
      ...
      const cached = (_a = serverTranslationCache[cacheKey]) == null ? void 0 : _a.get(key);
      if (cached) {
        return cached;
      }
...
function getCurrentLocale(route, i18nConfig) {
  var _a;
  return (((_a = route.params) == null ? void 0 : _a.locale) ?? i18nConfig.defaultLocale).toString();
}
function getRouteName(route, locale) {
  return ((route == null ? void 0 : route.name) ?? "").toString().replace("localized-", "").replace(new RegExp(`-${locale}$`), "");
}
function switchLocale(fromLocale, toLocale, route, router, i18nConfig) {
  var _a;
  const checkLocale = (_a = i18nConfig.locales) == null ? void 0 : _a.find((l) => l.code === toLocale);
  if (!checkLocale) {
...
const _01_plugin_YYhmPOJYgJ = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  ...
  return {
    provide: {
      ...
      tc: (key, count, defaultValue) => {
        ...
        return plural(translation == null ? void 0 : translation.toString(), count, getCurrentLocale(useRoute(), i18nConfig));
      },
      tn: (value, options) => {
        const locale = getCurrentLocale(useRoute(), i18nConfig);
...
const useLocaleHead = ({ addDirAttribute = true, identifierAttribute = "id", addSeoAttributes = true, baseUrl = "/" } = {}) => {
  ...
  function updateMeta() {
    const { defaultLocale, includeDefaultLocaleRoute } = (/* @__PURE__ */ useRuntimeConfig()).public.i18nConfig;
...
const _02_meta_rNQ7QfGk0T = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  const config = /* @__PURE__ */ useRuntimeConfig();
  const i18nConfig = config.public.i18nConfig;
...
const _03_define_NVktOUGOO7 = /* @__PURE__ */ defineNuxtPlugin((_nuxtApp) => {
  const config = /* @__PURE__ */ useRuntimeConfig();
  const route = useRoute();
  const router = useRouter();
  const i18nConfig = config.public.i18nConfig;
  ...
  useRouter().beforeEach(async (to, from, next) => {
    ...
    if (i18nConfig.includeDefaultLocaleRoute) {
      ...
      const { name } = to;
      let defaultRouteName = name == null ? void 0 : name.toString().replace("localized-", "").replace(new RegExp(`-${currentLocale}$`), "");
      if (!to.params.locale) {
        if (router.hasRoute(`localized-${(_a = to.name) == null ? void 0 : _a.toString()}-${currentLocale}`)) {
          defaultRouteName = `localized-${(_b = to.name) == null ? void 0 : _b.toString()}-${currentLocale}`;
        } else {
          defaultRouteName = `localized-${(_c = to.name) == null ? void 0 : _c.toString()}`;
        }
  ...
  const defineI18nRoute = async (routeDefinition) => {
    ...
    if (Object.values(normalizedLocales).length) {
      ...
      if (!normalizedLocales[currentLocale]) {
        let defaultRouteName = (_a = route.name) == null ? void 0 : _a.toString().replace("localized-", "").replace(new RegExp(`-${currentLocale}$`), "");
...
const _04_auto_detect_4GwBhKd0yj = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  var _a;
  let __temp, __restore;
  ...
  const supportedLocales = ((_a = i18nConfig.locales) == null ? void 0 : _a.map((locale) => locale.code)) ?? [];
  ...
  const acceptLanguage = (headers == null ? void 0 : headers["accept-language"]) ?? "";
  ...
  if (supportedLocales.includes(detectedLocale)) {
    ...
    userLocaleCookie.value = detectedLocale;
    [__temp, __restore] = executeAsync(() => navigateTo(router.resolve({ name: newRouteName, params: newParams }).href, { redirectCode: 301, external: true })), await __temp, __restore();
  } else {
...
const plugins = [
  unhead_2ib1LMFO1n,
  plugin,
  revive_payload_server_NfQwuc17fT,
  components_plugin_KR1HBZs4kY,
  _01_plugin_YYhmPOJYgJ,
  _02_meta_rNQ7QfGk0T,
  _03_define_NVktOUGOO7,
  _04_auto_detect_4GwBhKd0yj
];
const layouts = {};
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.13.1_@parcel+watcher@2.4.1_@types+node@20.16.5_encoding@0.1.13_eslint@9.9.1_jiti@1.21._4wan5ll6hswblwh4ka734stohi/node_modules/nuxt/dist/pages/runtime/app.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CgBNgfyw.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-B9Lt-Ai2.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.13.1_@parcel+watcher@2.4.1_@types+node@20.16.5_encoding@0.1.13_eslint@9.9.1_jiti@1.21._4wan5ll6hswblwh4ka734stohi/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.13.1_@parcel+watcher@2.4.1_@types+node@20.16.5_encoding@0.1.13_eslint@9.9.1_jiti@1.21._4wan5ll6hswblwh4ka734stohi/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, useRoute as a, useRouter as b, useHead as c, navigateTo as d, useRuntimeConfig as e, withoutTrailingSlash as f, hasProtocol as h, joinURL as j, nuxtLinkDefaults as n, parseQuery as p, resolveRouteObject as r, server as s, useNuxtApp as u, withTrailingSlash as w };
